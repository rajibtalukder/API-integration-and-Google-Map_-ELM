...
class _QuickDonateState extends State<QuickDonate> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color: primaryColor,
      padding: EdgeInsets.symmetric(horizontal: width/14, vertical: height/16),
      child: Column(
        children: [
          Row(
                   ...
                   const Text('Quick Donate',
                      ...
                      child: Row(
                        ...
                        children: [
                          for (int i in moneyList)
                            roundButton('£$i',_selectedIndex==i?alternate: primaryColor,_selectedIndex==i?alternate: white, _selectedIndex==i?white: primaryColor,
                                onPressed: () {
                                  setState(() {
                                    _selectedIndex=i;
                                    amount=i;
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    child: WheelChooser(
                                      onValueChanged: (s) {
                                        setState(() {
                                          amount=int.parse(s.toString().split('£')[1]);
                                        });
                                      },
                                      datas: [
                                      ...
                                      itemSize: 20,
                                      magnification: 1.2,
                                      selectTextStyle: const TextStyle(color: white),
                                      unSelectTextStyle:
                    ...
                    TextButton(
                      child: RichText(text: const TextSpan(
                          text: 'CLICK HERE TO ',style: TextStyle(color: primaryColor, letterSpacing: 1),
                          children: [
                            TextSpan(
                              text: 'ADD 20% ',style: TextStyle(color: secondaryColor, fontWeight: FontWeight.bold,letterSpacing: 1),
                            ),
                            TextSpan(
                              text: 'CLICK HERE TO',style: TextStyle(color: primaryColor,letterSpacing: 1),
                            )
